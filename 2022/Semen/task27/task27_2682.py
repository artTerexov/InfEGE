...
# ровно одно число так, чтобы сумма всех выбранных чисел оканчивалась на 4 и при этом была минимально
...
# количество пар N (1 ≤ N ≤ 100000). Каждая из следующих N строк содержит два натуральных числа, не
# превышающих 10 000.
...
with open("files/27-22a.txt") as f:
