...
# Входные данные представлены в файле task26-50.txt следующим образом. Первая строка содержит целое число N – общее количество чисел в наборе. Каждая из следующих N строк содержит одно число, не превышающее 109.
...
# 5
# 9
# В данном случае есть четыре подходящие пары: 2 и task16 (среднее арифметическое 9), 8 и 14 (среднее арифметическое 11), 9 и 11 (среднее арифметическое 10), 8 и task16 (среднее арифметическое 12). В ответе надо записать числа 4 и 9.
