...
def f(a, b, c, m, f1, f2):
    ...
    h = [f(a, b + 1, c + 1, m, f1, f2), f(a + 1, b, c + 1, m, f1, f2),
         f(a, b * 2, c + 1, m, f1, f2), f(a * 2, b, c + 1, m, f1, f2)]
...
for b in range(1, 205):
    if f(17, b, 0, 2, any, (lambda x, y: x == y)) == 1:
        print("№ 19 ->", b)
        break
print("№ 20 ->", end=" ")
for b in range(1, 205):
    if f(17, b, 0, 3, all, (lambda x, y: x == y)) == 1:
        print(b, end=" ")
print()

print("№ 21 ->", end=" ")
for b in range(1, 205):
    if f(17, b, 0, 4, all, (lambda x, y: x % 2 == y % 2)) == 1:
        print(b, end=" ")
print()
